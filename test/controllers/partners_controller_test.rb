...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { partner_description: @partner.partner_description, partner_name: @partner.partner_name } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { partner_description: @partner.partner_description, partner_name: @partner.partner_name } }
