...
class ArtistsTest < ApplicationSystemTestCase
  ...
  test "creating a Artist" do
    ...
    fill_in "Artist birthday", with: @artist.artist_birthday
    fill_in "Artist description", with: @artist.artist_description
    fill_in "Artist image", with: @artist.artist_image
    fill_in "Artist realname", with: @artist.artist_realname
    fill_in "Artist stagename", with: @artist.artist_stagename
